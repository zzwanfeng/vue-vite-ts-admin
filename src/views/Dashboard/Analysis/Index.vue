        ...
        <el-col :xl="12">
          <el-card shadow="hover" class="card">
            <div class="header-title" style="margin-bottom: 32px">
              ...
              <div class="btn-link" @click="handleExportExcel">
                <span style="margin-right: 5px; display: inline-block">Export</span><i class="el-icon-download"></i>
              </div>
            </div>
...
import WorldMap1 from '@/components/WorldMap/Index.vue'
