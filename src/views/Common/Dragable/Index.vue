  ...
  <div class="dragable-container">
    <el-card>
          ...
          <div class="page-title-right">
            <div style="margin-right: 10px">
              <span style="text-align: left"
                >拖拽组件常用于对当前活动列表进行优先级重新排列场景。<el-link
                  type="primary"
      ...
      <el-card class="box-card">
        ...
        <div class="section">
          <div ref="itemsRef">
            <div v-for="item in input" :key="item.id" class="external-events" :class="[item.classNames]">
              <i class="list-circle"></i>{{ item.task }}
            </div>
          </div>
        </div>
      </el-card>
...
.dragable-container {
  ...
  .page-title-box {
    box-sizing border-box display flex flex-direction row justify-content space-between align-items center .page-title {
      font-size: 18px;
      margin: 0;
      line-height: 85px;
      overflow: hidden;
